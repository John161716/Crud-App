...
if (conn != null) {
    ...
    if (propertyAddress.isEmpty() || propertyType.isEmpty() || tenantName.isEmpty() || tenantPhoneNumber.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Property Address, Property Type, Tenant Name, and Tenant Phone are required fields.", "Input Error", JOptionPane.ERROR_MESSAGE);
    ...
    if (conn != null) {
        try {
            ...
            String sql = "UPDATE rental_properties SET " +
                         ...
                         "WHERE tenant_name = ? AND tenant_phone = ?";
            ...
            // Use the tenant's name and phone to identify which record to update
            pstmt.setString(12, tenantName);  // Current tenant_name for matching record
            pstmt.setString(13, tenantPhoneNumber);  // Current tenant_phone for matching record
